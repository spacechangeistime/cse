...
batch_size = 32
image_size=(180, 180)
model_name = "dogs-vs-cats-with-feature-extraction.keras"
...
preprocessor = keras_hub.layers.ImageConverter.from_preset("xception_41_imagenet", image_size=image_size)
